...
function t1(event) {
  console.log(event);
  let value = document.querySelector(".div-1").textContent;
...
function t2(event) {
  console.log(event);
  return (document.querySelector(".out-2").textContent = event.altKey);
}
...
function t3(event) {
  console.log(event);
  let out = (document.querySelector(".div-3 ").style.width = w3 + "px");
  w3 += 5;
...
function t4(event) {
  console.log(event);
  let value = document.querySelector(".div-4").textContent;
...
//   console.log(event.target);
  let result = document.querySelector(".div-5").classList.toggle("active");
  return result;
}
