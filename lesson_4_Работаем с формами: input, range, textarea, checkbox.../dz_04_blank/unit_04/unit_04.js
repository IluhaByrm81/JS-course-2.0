...
function f4() {
   ...
   let cbInput = document.querySelector('.i-4');
...
function f5() {
   ...
   let cbInput = document.querySelector('.i-5');
   let out = document.querySelector('.out-5');

   if (cbInput.checked) {
      out.innerHTML = cbInput.value;
   } else {
      out.innerHTML = false;
   }
}
...
let but81 = document.createElement('button');
but81.innerHTML = '<button class="button-primary b-81">Task-81</button>';

let inp81 = document.createElement('input');
inp81.innerHTML = '<input type="text"  class="i-81" value="">';
...
function f81 () {
   ...
   let out1 = document.querySelector('.out-81');
...
function f10() {
   ...
   document.querySelector('.out-10').style.background = inp;
...
function f11() {
   ...
   let inp1 = document.querySelector('.i-111').value;
   let inp2 = document.querySelector('.i-112').value;
   document.querySelector('.i-112').value = inp1;
...
function f15() {
   ...
   let out1 = document.querySelector('.t-15');
...
function f16() {
   ...
   let s = document.querySelector('.s-16');
...
function f18() {
   ...
   document.querySelector('.i-18').value = s;
...
function f19() {
   ...
   let inp1 = document.querySelector('.i-191').value;
   let inp2 = document.querySelector('.i-192').value;
