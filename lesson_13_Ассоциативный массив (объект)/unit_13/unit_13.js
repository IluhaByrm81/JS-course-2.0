...
function f7() {
   ...
   let res = '';
   inp = document.querySelector('.i-7');
   out = document.querySelector('.out-7');

      if (a7[inp.value] !== undefined) res = 1;
      else res = 0;
...
function f8() {
   ...
   let res = '';
   inp = document.querySelector('.i-8').value;
   out = document.querySelector('.out-8');

   if (a8[inp] !== undefined) res = a8[inp]
   else res = 0
...
function f11() {
   ...
   for (let key in a11) {
      ...
      if (a11[inp.value] === a11[key]) {

         delete a11[inp.value];
         // console.log(a11);
      }
   }
...
function f19() {
   ...
   for (let key in a19) {
      ...
      for (let i = 0; i < a19[key].length; i++) {
         // console.log(a19[key][i]);
         if (inp.toLowerCase() === a19[key][i].toLowerCase()) {
