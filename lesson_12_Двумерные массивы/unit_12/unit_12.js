...
function f12() {
   ...
   // document.querySelector('.out-12').innerHTML = `${out}. количество 1 = ${outLength}`;
}
...
function f13() {
   ...
   for (let i = 0 ; i < 8; i++) {
      ...
      for (let k = 0 ; k < 8; k++) {
         ...
         if (poz % 2 === 0) out.push(1);
         if (poz % 2 !== 0) out.push(0);
         poz++;
      }
   ...
   console.log(a13);
   document.querySelector('.out-13').innerHTML = a13;
}
