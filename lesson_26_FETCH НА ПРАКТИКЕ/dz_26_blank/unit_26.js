...
function t2() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Ilya"
  )
    .then((data) => {
      return data.text();
    })
...
function t3() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=6&num2=8"
  )
    .then((data) => {
      return data.text();
    })
...
function t4() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=3&num2=10"
  )
    .then((data) => {
      return data.text();
    })
...
function t6() {
  fetch(
    "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&nim1=2&num2=55"
  )
    .then((data) => {
      return data.text();
    })
...
function t11() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=2&name=Ilya",
  })
    .then((response) => response.text())
    .then((response) => {
...
function t12() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=3&num1=8&num2=10",
  })
    .then((response) => response.text())
    .then((response) => {
...
function t13() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=4&num1=2&num2=10",
  })
    .then((response) => response.text())
    .then((response) => {
...
function t15() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: "auth=DdC33D7d2C2a7&action=6&num1=8&num2=10",
  })
    .then((response) => response.text())
    .then((response) => {
...
function t16() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    .then((response) => response.text())
    .then((response) => {
      document.querySelector(".out-16").innerHTML = `<img src="${response}">`;
    });
}
