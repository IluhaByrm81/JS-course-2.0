...
function f1(){
   ...
   let a = 4;
   let b = +document.querySelector('.i-1').value;
...
function f7(){
   ...
   let outAll = Math.pow(inp1, inp2);
   out.innerHTML = outAll;
...
function f15(){
   ...
   let s1 = +document.querySelector('.s-151').value; // 1 0
   let s2 = +document.querySelector('.s-152').value; // 1 0
   let s3 = document.querySelector('.s-153').value; // && ||  true  false
   let out = document.querySelector('.out-15');

   if ((s1 === 1 && s2 === 1 && s3 === '&&') || (s1 === 0 && s2 === 1 && s3 === '||') || (s1 === 1 && s2 === 0 && s3 === '||') || (s1 === 1 && s2 === 1 && s3 === '||')) {

      out.innerHTML = 1;

   } else if ((s1 === 0 && s2 === 0 && s3 === '&&') || (s1 === 1 && s2 === 0 && s3 === '&&') || (s1 === 0 && s2 === 1 && s3 === '&&') || (s1 === 0 && s2 === 0 && s3 === '||')) {
