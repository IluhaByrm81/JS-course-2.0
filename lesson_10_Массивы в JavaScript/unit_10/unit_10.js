...
let ar1 = ['Hello','World', 1, 3, 5, 7, 33, true, false];
...
let ar2 = ['Hello','World', 1, 3, 5, 7, 33, true, false];
let out2 = '';
...
let ar3 = ['Hello,','World', 1, 3, 5, 7, 33, true, false];
...
let ar4 = ['Hello,','World', 1, 'Ilya', 5, 7, 33, true, 81, false];
...
function f6() {
   ...
   ar6.push('Илья', 'Лев', 2, 'августа');

   document.querySelector('.out-6').innerHTML = ar6.join(' ');
}
...
function f7() {
   ...
   document.querySelector('.out-7').innerHTML = ar7.join(' ');
}
...
function f12() {
      ...
      ar12[ar12.length - 1] = res12;
   
   document.querySelector('.out-12').innerHTML = ar12.join(' ')
}
...
function f14() {
   ...
   for (let i = 0; i < ar14.length; i++) {
      ...
      res14[i] = ar14[(ar14.length - 1) - i];
   }
   document.querySelector('.out-14').innerHTML = res14.join(' ');
}
...
function f15() {
   ...
   document.querySelector('.out-15').innerHTML = res15.join(' ');
}
...
let ar16_odd = [];
let ar16_even = [];
let out_odd = document.querySelector('.out-16-odd');
let out_even = document.querySelector('.out-16-even');
...
function f16() {
   ...
   out_odd.innerHTML = ar16_odd.join(' ');
   out_even.innerHTML = ar16_even.join(' ');
   out_odd = [];
   out_even = [];
}
...
function f17() {
   ...
   document.querySelector('.out-17').innerHTML = res17.length;
}
...
function f18() {
   ...
   document.querySelector('.out-18').innerHTML = res18;
}
...
function f20() {
   ...
   document.querySelector('.out-20').innerHTML = res20;
}
