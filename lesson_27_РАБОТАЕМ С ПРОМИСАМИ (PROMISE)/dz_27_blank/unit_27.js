...
function t1() {
  let dataOne = new Promise((resolve, reject) => {
    fetch(
  ...
  let dataTwo = new Promise((resolve, reject) => {
    fetch(
      "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2"
    ).then((data2) => {
      resolve(data2.text());
    });
  });

  Promise.all([dataOne, dataTwo]).then((value) => {
...
function t2() {
  let dataOne = new Promise((resolve, reject) => {
    fetch(
      "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=3&num2=9"
    ).then((data1) => {
      resolve(data1.text());
    });
  });
  ...
  let dataTwo = new Promise((resolve, reject) => {
    fetch(
      "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=2&num2=10"
    ).then((data2) => {
      resolve(data2.text());
    });
  });
...
function t3() {
  ...
  let dataTwo = new Promise((resolve, reject) => {
    fetch(
      "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=2&num2=10"
    ).then((data2) => {
      resolve(data2.text());
    });
  });
...
function t4() {
  ...
  let dataTwo = new Promise((resolve, reject) => {
    fetch(
      "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1981"
    ).then((data2) => {
      resolve(data2.text());
    });
  });
  ...
  Promise.all([dataOne, dataTwo]).then((value) => {
    document.querySelector(
      ".out-4"
    ).innerHTML = `<img src="${value[0]}"></img> ${value[1]}`;
  });
}
...
function t6() {
  let dataOne = new Promise((resolve, reject) => {
    fetch("http://getpost.itgid.info/index2.php", {
      ...
      body: "auth=DdC33D7d2C2a7&action=3&num1=3&num2=20",
    }).then((data1) => {
      resolve(data1.text());
    });
  });
  ...
  let dataTwo = new Promise((resolve, reject) => {
    fetch("http://getpost.itgid.info/index2.php", {
      ...
      body: "auth=DdC33D7d2C2a7&action=4&num1=3&num2=10",
    }).then((data2) => {
      resolve(data2.text());
    });
  });
...
function t7() {
  ...
  let dataTwo = new Promise((resolve, reject) => {
    fetch("http://getpost.itgid.info/index2.php", {
      ...
      body: "auth=DdC33D7d2C2a7&action=6&num1=3&num2=10",
    }).then((data2) => {
      resolve(data2.text());
    });
  });
...
function t8() {
  ...
  let dataTwo = new Promise((resolve, reject) => {
    fetch("http://getpost.itgid.info/index2.php", {
      ...
      body: "auth=DdC33D7d2C2a7&action=8&year=1981",
    }).then((data2) => {
      resolve(data2.text());
    });
  });
