...
function t2() {
   ...
   xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Ilya", true);
   xhttp.send();
}
...
function t4() {
   ...
   xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=3&num2=5", true);
   xhttp.send();
}
...
function t9() {
   ...
   xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=9&m=1&d=1&y=1", true);
   xhttp.send();
}
...
function t11() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Ilya", true);

   xhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp2.send('auth=DdC33D7d2C2a7&action=2')
}
...
function t12() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=3&num2=6", true);

   xhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp2.send('auth=DdC33D7d2C2a7&action=3')
}
...
function t13() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=4&num2=8", true);

   xhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp2.send('auth=DdC33D7d2C2a7&action=4')
}
...
function t14() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=5", true);
...
function t15() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=4&num2=9", true);

   xhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp2.send('auth=DdC33D7d2C2a7&action=6')
}
...
function t16() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=7", true);
...
function t17() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1981", true);

   xhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp2.send('auth=DdC33D7d2C2a7&action=8')
}
...
function t18() {
   ...
   xhttp2.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=9&m=1&d=1&y=1", true);

   xhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
   xhttp2.send('auth=DdC33D7d2C2a7&action=9')
}
